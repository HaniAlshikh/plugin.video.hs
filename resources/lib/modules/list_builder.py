...
class ListBuilder(object):
    ...
    def season_list_builder(self, seasons, **params):
        """
        ...
        return self._common_menu_builder(
            seasons, #shows.TraktSyncDatabase().get_season_list(show_id, **params),
            g.CONTENT_SEASON,
            "seasonEpisodes",
            **params
        )

    def episode_list_builder(self, list, **params):
        """
    ...
    def show_list_builder(self, trakt_list, **params):
        ...
        self._common_menu_builder(
            trakt_list, #shows.TraktSyncDatabase().get_show_list(trakt_list, **params),
            g.CONTENT_SHOW,
            action,
            **params
        )
    ...
    def movie_menu_builder(self, trakt_list, **params):
        ...
        self._common_menu_builder(
            trakt_list, # movies.TraktSyncDatabase().get_movie_list(trakt_list, **params),
            g.CONTENT_MOVIE,
            action,
            **params
        )
    ...
    def _post_process(self, item, prepend_date=False, mixed_list=False):
        ...
        MetadataHandler.improve_media(item)
