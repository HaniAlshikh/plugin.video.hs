...
from resources.lib.modules.scrapers import source_utils
from resources.lib.modules.scrapers.common_types import UrlParts
from resources.lib.modules.scrapers.third_party.cloudscraper import cloudscraper
...
class Request(object):
    ...
    def _request_core(self, request, sequental = None, cf_retries=3):
        ...
        try:
            ...
            # g.log('%s %s' % (request.url, self.exc_msg), 'notice')
